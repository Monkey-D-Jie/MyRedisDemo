 ...
 *
 * @Author: Wangjie
 * @Date: 2018-05-15 11:31
 * @Description: java使用redis的测试类
 * To change this template use File | Settings | File and Templates.
 * 测试类来自：
 * Windows 64位下安装Redis超详细教程 - CSDN博客
 * https://blog.csdn.net/jinwufeiyang/article/details/52156817
 */
...
public class JedisUtilTest {
    ...
    public void setUp() {
        ...
        System.out.println("redis已连接成功！！！-------------------------");
        this.jedis = pool.getResource();
        jedis.set("lu","Hello World");
//   jedis.auth("password");
    }
...
//        jedis.srem("sname", "noname");
        ...
        System.out.println("时间打印测试-------------------");
        String date = "2018-05-15 17:57:05";
        long expireTime =DateFormatKit.convert(DateFormatKit.DATE_FORMAT,date).getTime();
        long currentTime = System.currentTimeMillis();
        System.out.println("expireTime:"+expireTime+",currentTime"+currentTime);
    }
